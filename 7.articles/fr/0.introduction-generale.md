...
Pour passer d'un signal audio brut à une application mobile fonctionnelle, GroovyMorning repose sur les cinq piliers suivants :
...
5. **L'application mobile** : Une application mobile permettant aux utilisateurs de **customiser la grille de la radio** et d'écouter cette dernière.
![](../en/assets/appli-demo.gif)

---

## Structure de la série technique

La série est structurée en douze chapitres abordant chacun une facette spécifique du pipeline de traitement.
...
### 12. Finetuning des Modèles d'IA
Exploration des architectures (CamemBERT, AST, Wav2Vec2) et techniques de post-traitement pour affiner la précision de la détection.
[Accéder à l'article](./12.finetuning-modeles-ia.md)

[La version anglaise](../en/0.general-introduction.md)
