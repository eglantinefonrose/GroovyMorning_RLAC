...
![](assets/appli-demo.gif)

---

## Structure of the Technical Series

The series is structured into twelve chapters, each addressing a specific aspect of the processing pipeline.

![](assets/schema-essai-ia-en.png)
...
[Access the article](./8.end-to-end-test-validation.md)
...
### 12. AI Models Finetuning
Exploration of architectures (CamemBERT, AST, Wav2Vec2) and post-processing techniques to refine detection accuracy.
[Access the article](./12.ai-models-finetuning.md)
