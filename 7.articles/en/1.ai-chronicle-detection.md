...
# AI Radio Chronicle Detection by AI
...
[Detection via audio](ia-models-training/audio/article-audio-training.md) or [detection via text](ia-models-training/text/article-text-dataset-creation.md)
